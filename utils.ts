...
export function getDefaultAvatar(theme: string): string {
  const themeMap: Record<string, string> = {
    'slate': '/default-avatars/slate.png',
    'ocean': '/default-avatars/ocean.png',
    'forest': '/default-avatars/forest.png',
    'rose': '/default-avatars/rose.png',
    'sunset': '/default-avatars/sunset.png',
    'system': '/default-avatars/system.png',
  };
