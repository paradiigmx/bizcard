...
export const GlobeAltIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0121 10.5c0 .962-.088 1.9-.254 2.805m-15.686-4.39A11.953 11.953 0 003 10.5c0 .962.088 1.9.254 2.805m-.254-2.805a10.062 10.062 0 011.5-5.164m13.5 10.328A10.062 10.062 0 0119.5 15.5" />
    </svg>
);
...
export const ListsIcon = ListBulletIcon;
