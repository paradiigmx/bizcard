...
import { ArrowLeftIcon, EditIcon, SaveIcon, LinkIcon, IdentificationIcon, StarIcon, InfoIcon, XIcon, ClockIcon, SearchIcon, ChevronDownIcon, ChevronUpIcon, PlusIcon } from './icons';
            ...
            <div className="p-4 sm:p-6 bg-[rgb(var(--color-bg-secondary))] rounded-lg shadow space-y-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        {!isDemoEvent && (isEditing ? ( <button onClick={handleSave} className="p-2 text-[rgb(var(--color-success))] hover:opacity-80"><SaveIcon className="h-5 w-5" /></button>) : (<button onClick={() => setIsEditing(true)} className="p-2 text-[rgb(var(--color-text-subtle))] hover:text-[rgb(var(--color-text-primary))]"><EditIcon className="h-5 w-5" /></button> ))}
                    </div>
                </div>
                ...
                {isEditing ? (
                    ...
                    <div className="space-y-2">
                        ...
                        {event.url && <a href={event.url} target="_blank" rel="noopener noreferrer" className="text-[rgb(var(--color-primary))] hover:underline break-all">{event.url}</a>}
